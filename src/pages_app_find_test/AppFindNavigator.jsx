    ...
    useEffect(() => {
        ...
        if (isSoundOffClicked) {
          synth.cancel();
            ...
            speakText("어떤 기능이 필요하신가요? 아래의 버튼 중 하나를 선택해주세요.");
        }
        //생활편의
          ...
          else if (decodeURI(location.pathname) === decodeURI(`/AppsFindResult/날씨`)) {
            speakText("날씨와 관련된 어플을 찾아봤어요! 해당 어플이 궁금하시다면, 자세히 버튼을 눌러보세요!");
        } 
          else if (decodeURI(location.pathname) === decodeURI(`/AppsFindResult/지도`)) {
            speakText("지도와 관련된 어플을 찾아봤어요! 해당 어플이 궁금하시다면, 자세히 버튼을 눌러보세요!");
        } 
          else if (decodeURI(location.pathname) === decodeURI(`/AppsFindResult/지하철`)) {
            speakText("지하철과 관련된 어플을 찾아봤어요! 해당 어플이 궁금하시다면, 자세히 버튼을 눌러보세요!");
        } 
          else if (decodeURI(location.pathname) === decodeURI(`/AppsFindResult/버스`)) {
            speakText("버스와 관련된 어플을 찾아봤어요! 해당 어플이 궁금하시다면, 자세히 버튼을 눌러보세요!");
        } 
          else if (decodeURI(location.pathname) === decodeURI(`/AppsFindResult/택시`)) {
            speakText("택시와 관련된 어플을 찾아봤어요! 해당 어플이 궁금하시다면, 자세히 버튼을 눌러보세요!");
        } 
          else if (decodeURI(location.pathname) === decodeURI(`/AppsFindResult/배달 음식`)) {
            speakText("배달 음식과 관련된 어플을 찾아봤어요! 해당 어플이 궁금하시다면, 자세히 버튼을 눌러보세요!");
        }
          else if (decodeURI(location.pathname) === decodeURI(`/AppsFindResult/식료품 및 생활용품 배송`)) {
            speakText("식료품 및 생활용품 배송과 관련된 어플을 찾아봤어요! 해당 어플이 궁금하시다면, 자세히 버튼을 눌러보세요!");
        }
          else if (decodeURI(location.pathname) === decodeURI(`/AppsFindResult/일정 관리`)) {
            speakText("일정관리와 관련된 어플을 찾아봤어요! 해당 어플이 궁금하시다면, 자세히 버튼을 눌러보세요!");
        }     
        ...
        else if (decodeURI(location.pathname) === decodeURI('/AppsFindResult/여행')) {
            speakText("여행과 관련된 어플을 찾아봤어요! 해당 어플이 궁금하시다면, 자세히 버튼을 눌러보세요!")
        }
        else if (decodeURI(location.pathname) === decodeURI('/AppsFindResult/낚시')) {
            speakText("낚시와 관련된 어플을 찾아봤어요! 해당 어플이 궁금하시다면, 자세히 버튼을 눌러보세요!")
        }
        else if (decodeURI(location.pathname) === decodeURI('/AppsFindResult/등산')) {
            speakText("등산과 관련된 어플을 찾아봤어요! 해당 어플이 궁금하시다면, 자세히 버튼을 눌러보세요!")
        }
        ...
        else if (decodeURI(location.pathname) === decodeURI('/AppsFindResult/일상공유')){
            speakText("일상 공유와 관련된 어플을 찾아봤어요! 해당 어플이 궁금하시다면, 자세히 버튼을 눌러보세요!");
        }
        ...
        else if (decodeURI(location.pathname) === decodeURI('/AppsFindResult/수면')) {
            speakText("수면과 관련된 어플을 찾아봤어요! 해당 어플이 궁금하시다면, 자세히 버튼을 눌러보세요!");
        }
